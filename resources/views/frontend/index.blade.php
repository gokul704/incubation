...
<head>
  ...
  <title>Incubation center GCET</title>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid">
      <div class="row justify-content-center">
        ...
        <h1 class="logo mr-auto"><a href="">Incubation Center<span></span></a></h1>
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li><a href="#services">Announcements</a></li>
        ...
        <div class="row no-gutters">
          <div class="content col-xl-5 d-flex align-items-stretch">
            <div class="content">
              <h3>About us</h3>
              <p>
                Incubation center GCET is started to boost student's innovation and thinking ability.
              </p>
                    ...
                    <table class="table table-bordered mb-5">
                        ...
                        <tbody>
                            ...
                            <tr class="table-secondary">
                                ...
                                <td>{{ $data->title }}</td>
                                <td>{{ $data->subtitle }}</td>
                                <td><img src="{{ URL::to('/') }}/images/{{ $data->image }}" width="50%"></td>
                                <td>            @if(strlen($data->body) > 50)
                                    {{substr($data->body,0,50)}}
                                    <span class="read-more-show hide_content">More<i class="fa fa-angle-down"></i></span>
                                    <span class="read-more-content"> {{substr($data->body,100,strlen($data->body))}}
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Incubation Center<span>.</span></h3>
            <!-- <p>
              A108 Adam Street <br>
